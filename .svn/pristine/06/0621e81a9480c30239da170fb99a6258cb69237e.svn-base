		...
		<form action="${ctx }/user/logon" method="get">
			<table>
				<tr>
					...
					<td><input id="username" name="username" class="login-input" value="leaderuser" placeholder="用户名（见下左表）" /></td>
				</tr>
				<tr>
					<td style="text-align: right;">密码：</td>
					<td><input id="password" name="password" type="password" value="000000" class="login-input" placeholder="默认为：000000" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>
