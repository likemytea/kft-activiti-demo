...
<body>
	...
	<form:form id="inputForm" action="${ctx}/oa/leave/start" method="post" class="form-horizontal">
		<fieldset>
			...
			<tr>
				<td>开始时间：</td>
				<td><input type="text" id="startTime" name="startTime" value="2016-07-07 00:00"/></td>
			</tr>
			<tr>
				<td>结束时间：</td>
				<td><input type="text" id="endTime" name="endTime" value="2016-07-29 00:00"/></td>
			</tr>
			<tr>
				<td>请假原因：</td>
				<td>
					<textarea name="reason">请假原因：没事儿，休息休息</textarea>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
